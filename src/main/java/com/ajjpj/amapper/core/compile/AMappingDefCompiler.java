...
public class AMappingDefCompiler {
    ...
    public AMappingDefCompiler(Collection<? extends AObjectMappingDef> objectMappingDefs, Collection<? extends AValueMappingDef> valueMappingDefs) throws Exception {
        compCtx = new ACompilationContextImpl(valueMappingDefs);
    ...
    AObjectMappingDef compileObjectMappingDef(ACompilableObjectMappingDef orig) throws Exception {
        ...
        final ACodeBuilderForMappingDef builder = new ACodeBuilderForMappingDef(AObjectMappingDef.class.getName());
