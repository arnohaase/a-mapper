...
public class PrePostProcessorTest {
    ...
    final AMapper mapper = new AMapperImpl<Object, RuntimeException>(objectMappingDefs, valueMappingDefs, AMapperLogger.StdOut, helperFactory, ie, NoContextExtractor.INSTANCE, Arrays.asList(pre), Arrays.asList(post));
